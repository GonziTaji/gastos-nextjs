...
export default class MasterDetail extends React.Component<MasterDetailProps, MasterDetailStatus> {
    constructor(props: MasterDetailProps) {
        super(props);
